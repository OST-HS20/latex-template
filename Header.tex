...
% https://ctan.math.washington.edu/tex-archive/macros/latex/contrib/trfsigns/trfsigns.pdf
\newcommand{\transform}{\mbox{\setlength{\unitlength}{0.1em}%
	\begin{picture}(30,10)%
		\put(7,3){\circle{4}}%
		\put(9,3){\line(1,0){13}}%
		\put(23,3){\circle*{4}}%
...
\newcommand{\itransform}{\mbox{\setlength{\unitlength}{0.1em}%
	\begin{picture}(30,10)%
		\put(7,3){\circle*{4}}%
		\put(9,3){\line(1,0){13}}%
		\put(23,3){\circle{4}}%
